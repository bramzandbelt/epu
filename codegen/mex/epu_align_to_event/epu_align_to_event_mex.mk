...
MAKEFILE = epu_align_to_event_mex.mk

include epu_align_to_event_mex.mki
...
SYS_INCLUDE += -I "/Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_align_to_event"
...
%.$(OBJEXT) : /Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_align_to_event/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_align_to_event/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
