...
MAKEFILE = epu_compute_trajectory_onset_mex.mk

include epu_compute_trajectory_onset_mex.mki
...
SRC_FILES =  \
	...
	filter.c \
	median.c \
	epu_compute_trajectory_onset_initialize.c \
	epu_compute_trajectory_onset_terminate.c \
	epu_compute_trajectory_onset_api.c \
	epu_compute_trajectory_onset_emxutil.c \
	epu_compute_trajectory_onset_mex.c

MEX_FILE_NAME_WO_EXT = epu_compute_trajectory_onset_mex
...
SYS_INCLUDE += -I "/Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_compute_trajectory_onset"
...
%.$(OBJEXT) : /Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_compute_trajectory_onset/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_compute_trajectory_onset/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
