...
MAKEFILE = epu_n_unit_ba_mex.mk

include epu_n_unit_ba_mex.mki


SRC_FILES =  \
	epu_n_unit_ba_mexutil.c \
	epu_n_unit_ba_data.c \
	epu_n_unit_ba.c \
	rdivide.c \
	log.c \
	all.c \
	...
	exp.c \
	mean.c \
	epu_n_unit_ba_initialize.c \
	epu_n_unit_ba_terminate.c \
	epu_n_unit_ba_api.c \
	epu_n_unit_ba_emxutil.c \
	epu_n_unit_ba_mex.c

MEX_FILE_NAME_WO_EXT = epu_n_unit_ba_mex
...
SYS_INCLUDE += -I "/Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_n_unit_ba"
...
%.$(OBJEXT) : /Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_n_unit_ba/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/bram/Documents/EPU/Simulation_2012Aug28/m-files/codegen/mex/epu_n_unit_ba/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
