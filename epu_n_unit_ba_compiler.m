function epu_n_unit_ba_compiler
% This function compiles the epu_n_unit_ba.m file to a MEX file
...
codegen -config cfg epu_n_unit_ba -args {c_v,c_theta,c_k,c_affTime,c_effTime,c_pN,c_dMeth,c_iAT}